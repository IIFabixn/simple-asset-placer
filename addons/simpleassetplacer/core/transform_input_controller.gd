...
func process_keyboard_input(
	camera: Camera3D, state: TransformState, settings: Dictionary
) -> Dictionary:
	...
	if (
		pos_input.position_forward_pressed
		or pos_input.position_backward_pressed
		or pos_input.position_left_pressed
		or pos_input.position_right_pressed
	):
...
func process_height_adjustment(
	pos_input: PositionInputState, state: TransformState, settings: Dictionary
) -> void:
...
func process_rotation(
	rot_input: RotationInputState, state: TransformState, settings: Dictionary
) -> void:
...
func process_scale(
	scale_input: ScaleInputState, state: TransformState, settings: Dictionary
) -> void:
