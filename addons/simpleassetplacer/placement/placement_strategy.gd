...
static func create_ray_query(
	from: Vector3, to: Vector3, collision_mask: int, exclude: Array = []
...
static func project_to_horizontal_plane(
	from: Vector3,
	direction: Vector3,
	plane_height: float,
...
static func project_to_xy_plane(
	from: Vector3,
	direction: Vector3,
...
static func project_to_yz_plane(
	from: Vector3,
	direction: Vector3,
	plane_distance: float,
	fallback: Vector3 = Vector3.ZERO,
