...
const CollisionPlacementStrategy = preload("res://addons/simpleassetplacer/collision_placement_strategy.gd")
const PlanePlacementStrategy = preload("res://addons/simpleassetplacer/plane_placement_strategy.gd")
