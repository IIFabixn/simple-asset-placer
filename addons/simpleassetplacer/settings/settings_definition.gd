...
# Setting types
enum SettingType { BOOL, FLOAT, STRING, VECTOR3, KEY_BINDING, OPTION }  # Dropdown/OptionButton
...
class SettingMeta:
	...
	func _init(
		p_id: String, p_editor_key: String, p_default, p_type: SettingType, p_label: String = ""
	):
		id = p_id
...
static func get_all_settings() -> Array:
	...
	var placement_strategy = SettingMeta.new(
		"placement_strategy",
		"simple_asset_placer/placement_strategy",
		"collision",
		SettingType.OPTION,
		"Placement Strategy"
	)
	...
	var align_normal = SettingMeta.new(
		"align_with_normal",
		"simple_asset_placer/align_with_normal",
		false,
		SettingType.BOOL,
	...
	var snap_enabled = SettingMeta.new(
		"snap_enabled",
		"simple_asset_placer/snap_enabled",
		false,
		SettingType.BOOL,
	...
	var random_rotation = SettingMeta.new(
		"random_rotation",
		"simple_asset_placer/random_rotation",
		false,
		SettingType.BOOL,
		"Random Y Rotation"
	)
	...
	var smooth_transforms_setting = SettingMeta.new(
		"smooth_transforms",
		"simple_asset_placer/smooth_transforms",
		true,
		SettingType.BOOL,
		"Smooth Transforms"
	)
	...
	var smooth_transform_speed = SettingMeta.new(
		"smooth_transform_speed",
		"simple_asset_placer/smooth_transform_speed",
		8.0,
		SettingType.FLOAT,
	...
	var scale_multiplier = SettingMeta.new(
		"scale_multiplier",
		"simple_asset_placer/scale_multiplier",
		1.0,
		SettingType.FLOAT,
		"Scale Multiplier"
	)
	...
	# Placement Settings
	var continuous_placement_enabled = SettingMeta.new(
		"continuous_placement_enabled",
		"simple_asset_placer/continuous_placement_enabled",
		true,
		SettingType.BOOL,
	...
	var auto_select_placed = SettingMeta.new(
		"auto_select_placed",
		"simple_asset_placer/auto_select_placed",
		true,
		SettingType.BOOL,
		"Auto-select Placed Node"
	)
	...
	var cursor_warp_enabled = SettingMeta.new(
		"cursor_warp_enabled",
		"simple_asset_placer/cursor_warp_enabled",
		true,
		SettingType.BOOL,
		"Enable Cursor Warp"
	)
	...
	var parent_placement_mode = SettingMeta.new(
		"parent_placement_mode",
		"simple_asset_placer/parent_placement_mode",
		PluginConstants.DEFAULT_PARENT_MODE,
		SettingType.OPTION,
		"Parent Placement Mode"
	)
	parent_placement_mode.section = "basic"
	parent_placement_mode.options = [
	...
	var custom_parent_path = SettingMeta.new(
		"custom_parent_path",
		"simple_asset_placer/custom_parent_path",
		"",
		SettingType.STRING,
		"Custom Parent Path"
	)
	...
	var auto_parent_name = SettingMeta.new(
		"auto_parent_name",
		"simple_asset_placer/auto_parent_name",
		PluginConstants.DEFAULT_AUTO_PARENT_NAME,
		SettingType.STRING,
		"Auto-Created Parent Name"
	)
	...
	var snap_offset = SettingMeta.new(
		"snap_offset",
		"simple_asset_placer/snap_offset",
		Vector3.ZERO,
		SettingType.VECTOR3,
		"Grid Offset"
	)
	...
	var snap_y_enabled = SettingMeta.new(
		"snap_y_enabled",
		"simple_asset_placer/snap_y_enabled",
		false,
		SettingType.BOOL,
		"Enable Y-Axis Snap"
	)
	...
	var snap_y_step = SettingMeta.new(
		"snap_y_step", "simple_asset_placer/snap_y_step", 1.0, SettingType.FLOAT, "Y-Axis Snap Step"
	)
	...
	var snap_center_x = SettingMeta.new(
		"snap_center_x",
		"simple_asset_placer/snap_center_x",
		false,
		SettingType.BOOL,
		"Snap Center X"
	)
	...
	var snap_center_y = SettingMeta.new(
		"snap_center_y",
		"simple_asset_placer/snap_center_y",
		false,
		SettingType.BOOL,
		"Snap Center Y"
	)
	...
	var snap_center_z = SettingMeta.new(
		"snap_center_z",
		"simple_asset_placer/snap_center_z",
		false,
		SettingType.BOOL,
		"Snap Center Z"
	)
	...
	var snap_rotation_enabled = SettingMeta.new(
		"snap_rotation_enabled",
		"simple_asset_placer/snap_rotation_enabled",
		false,
		SettingType.BOOL,
	...
	var snap_rotation_step = SettingMeta.new(
		"snap_rotation_step",
		"simple_asset_placer/snap_rotation_step",
		15.0,
		SettingType.FLOAT,
		"Rotation Snap Step (degrees)"
	)
	...
	# Scale Snap Settings
	var snap_scale_enabled = SettingMeta.new(
		"snap_scale_enabled",
		"simple_asset_placer/snap_scale_enabled",
		false,
		SettingType.BOOL,
	...
	var snap_scale_step = SettingMeta.new(
		"snap_scale_step",
		"simple_asset_placer/snap_scale_step",
		0.1,
		SettingType.FLOAT,
		"Scale Snap Step"
	)
	...
	var reset_height_on_exit = SettingMeta.new(
		"reset_height_on_exit",
		"simple_asset_placer/reset_height_on_exit",
		false,
		SettingType.BOOL,
	...
	var reset_scale_on_exit = SettingMeta.new(
		"reset_scale_on_exit",
		"simple_asset_placer/reset_scale_on_exit",
		false,
		SettingType.BOOL,
		"Reset Scale on Exit"
	)
	...
	var reset_rotation_on_exit = SettingMeta.new(
		"reset_rotation_on_exit",
		"simple_asset_placer/reset_rotation_on_exit",
		false,
		SettingType.BOOL,
	...
	var reset_position_on_exit = SettingMeta.new(
		"reset_position_on_exit",
		"simple_asset_placer/reset_position_on_exit",
		false,
		SettingType.BOOL,
	...
	_add_key_binding(
		settings, "cycle_previous_asset_key", "BRACKETLEFT", "Previous Asset ([)", "keybinds"
	)

	# Modifier Keys
	_add_key_binding(settings, "reverse_modifier_key", "SHIFT", "Reverse Modifier", "keybinds")
	_add_key_binding(
		settings, "large_increment_modifier_key", "ALT", "Large Increment Modifier", "keybinds"
	)
	_add_key_binding(
		settings, "fine_increment_modifier_key", "CTRL", "Fine Increment Modifier", "keybinds"
	)
	...
	_add_increment(
		settings, "height_adjustment_step", 0.1, "Height Step", "increments", 0.01, 5.0, 0.01
	)
	_add_increment(
		settings,
		"fine_height_increment",
		0.01,
		"Height Step (Fine/CTRL)",
		"increments",
		0.001,
		0.5,
		0.001
	...
	_add_increment(
		settings, "rotation_increment", 15.0, "Rotation Step", "increments", 1.0, 180.0, 1.0
	)
	_add_increment(
		settings,
		"fine_rotation_increment",
		5.0,
		"Rotation Step (Fine/CTRL)",
		"increments",
		0.1,
		45.0,
		0.1
	...
	_add_increment(
		settings, "position_increment", 1.0, "Position Step", "increments", 0.1, 10.0, 0.1
	)
	_add_increment(
		settings,
		"fine_position_increment",
		0.1,
		"Position Step (Fine/CTRL)",
		"increments",
		0.01,
		1.0,
		0.01
	...
	var debug_commands = SettingMeta.new(
		"debug_commands",
		"simple_asset_placer/debug_commands",
		false,
		SettingType.BOOL,
	...
	var log_level = SettingMeta.new(
		"log_level", "simple_asset_placer/log_level", "info", SettingType.OPTION, "Logging Level"
	)
...
static func _add_key_binding(
	settings: Array, id: String, default_key: String, label: String, section: String
):
	var meta = SettingMeta.new(
		id, "simple_asset_placer/" + id, default_key, SettingType.KEY_BINDING, label
	)
...
static func _add_increment(
	...
	var meta = SettingMeta.new(
		id, "simple_asset_placer/" + id, default_val, SettingType.FLOAT, label
	)
	meta.section = section
