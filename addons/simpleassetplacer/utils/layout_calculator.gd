...
static func calculate_grid_columns(
	available_width: float, item_size: int, item_spacing: int = 12, safety_margin: int = 20
) -> int:
...
static func calculate_responsive_thumbnail_size(
	dock_width: float, min_size: int = THUMBNAIL_SIZE_MIN, max_size: int = THUMBNAIL_SIZE_MAX
) -> int:
...
static func calculate_item_position(
	index: int, columns: int, item_width: int, item_height: int, spacing: int = 12
) -> Vector2:
...
static func calculate_grid_size(
	item_count: int, columns: int, item_width: int, item_height: int, spacing: int = 12
) -> Vector2:
...
static func calculate_items_per_row(
	container_width: float, item_size: int, min_items: int = 1, max_items: int = 10
) -> int:
...
static func clamp_thumbnail_size(
	size: int, min_size: int = THUMBNAIL_SIZE_MIN, max_size: int = THUMBNAIL_SIZE_MAX
) -> int:
