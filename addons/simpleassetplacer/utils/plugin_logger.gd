...
enum LogLevel { DEBUG, INFO, WARNING, ERROR }  # Detailed debugging information  # General informational messages  # Warning messages for potential issues  # Error messages for failures
